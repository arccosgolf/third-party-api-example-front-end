...
export const getUrlSearchParams = (params: { [k: string]: any }): URLSearchParams =>
    new URLSearchParams(_filterBadParams(params))
...
export const queryStringify = (params: { [k: string]: any }, options: QueryStringifyOptions = defaultOptions): string =>
    Object.entries(_filterBadParams(params))
